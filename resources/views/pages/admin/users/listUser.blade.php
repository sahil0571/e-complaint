                                                ...
                                                @if ($user->role_id == 2)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                                <span
                                                                    class="badge rounded-pill badge-light-danger me-1">Banned</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @if ($user->verified == 1)
                                                                <span
                                                                    class="badge rounded-pill badge-light-success me-1">Verified</span>
                                                            @else
                                                                <span
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    @if ($user->status == 0)
                                                                        <a class="dropdown-item"
                                                                            href="/edit-user-status/{{ $user->id }}">
                                                                            <i data-feather='unlock'
                                                                                style="fill: #0cf00c47;"></i>
                                                                            <span> &nbsp; Activate</span>
                                                                        </a>
                                                                    @else
                                                                        <a class="dropdown-item"
