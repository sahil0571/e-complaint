                ...
                <section id="dashboard-ecommerce">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Make new Post.</h4>
                        ...
                        <div class="card-body">
                            <form class="auth-register-form mt-2" id="postForm" action="{{ route('admin.makePost') }}"
                                ...
                                <div class="mb-1">
                                    ...
                                    <input class="form-control" id="title" type="text" name="title"
                                        aria-describedby="title" value="{{old('title')}}" tabindex="1" />
                                    @error('title')
                                ...
                                <div class="mb-1">
                                    ...
                                    <input class="form-control" id="sub_title" type="text" name="sub_title"
                                        aria-describedby="sub_title" value="{{old('sub_title')}}" autofocus="" tabindex="1" />
                                    @error('sub_title')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <input class="form-control" value="{{old('slug')}}" id="slug" type="text" name="slug" aria-describedby="slug"
                                ...
                                <div class="col-12 mb-2">
                                    <div class="border rounded p-2">
                                        ...
                                        <div class="d-flex flex-column flex-md-row">
                                            <img src="" id="blog-feature-image" class="rounded me-2 mb-1 mb-md-0"
