                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="{{ asset('/images/pages/register-v2.svg') }}"
                                    alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Register-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">E-Complaint Sytem Registration 🚀</h2>
                                ...
                                @endif
                                <form class="auth-register-form mt-2" action="{{ route('register.post') }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-1">
                                        <label class="form-label fw-bold" for="name">Username</label>
                                        <input class="form-control" id="name" type="text" name="name"
                                            value="{{ old('name') }}" placeholder="johndoe" aria-describedby="name"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="email" type="email" name="email"
                                            ...
                                            aria-describedby="email" tabindex="2" required />
                                        @error('email')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        <label class="form-label fw-bold" for="email">Enrollment number<span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" id="enrollment_no" type="text"
                                            name="enrollment_no" value="{{ old('enrollment_no') }}"
                                            placeholder="Enter enrollment No." aria-describedby="enrollment_no"
                                            tabindex="2" required />
                                        @error('enrollment_no')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="photo" type="file" name="photo"
                                            placeholder="Add photo" aria-describedby="photo" tabindex="2" required />
                                        @error('photo')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
